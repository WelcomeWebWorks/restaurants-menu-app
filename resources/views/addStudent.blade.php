    ...
    <div class="container">
        ...
        @else
            <form class="inputs" action="{{ route('addStudent') }}" method="POST">
                ...
                <input type="text" id="student_department" name="student_department" placeholder="Department & Year (e.g. ECE 3Year , IT 4Year, CSE 3Year)" required oninput="this.value = this.value.toUpperCase();">
