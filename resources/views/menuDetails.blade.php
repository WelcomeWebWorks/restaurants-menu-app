    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editMenuForm').on('submit', function(e) {
                ...
                // Perform AJAX request to update the menu
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Optionally, update the table row with new data or reload the page
                        location.reload();
                    },
                    error: function(xhr, status, error) {
                        toastr.error('Failed to update the menu. Please try again.');
                    }
                });
            });
        });
